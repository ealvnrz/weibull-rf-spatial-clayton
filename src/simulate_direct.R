# Simulate Weibull random fields (direct, no copula)
...
# Save results as CSV
write.csv(res, file = file.path(output_dir, "weibull_direct_simulations.csv"), 
          row.names = FALSE)
write.csv(results_summary, file = file.path(output_dir, "weibull_direct_summary.csv"), 
          row.names = FALSE)
...
cat("- data/processed/weibull_direct_simulations.csv\n")
cat("- data/processed/weibull_direct_summary.csv\n")
